    ...
    if selected_course:
        ...
        if selected_sections:
            ...
            for section in selected_sections:
                # Remove (O) prefix for querying data
            ...
            if all_stats:
                ...
                if st.button("Download Report"):
                    ...
                    st.download_button(
                        label="Download CSV",
                        data=csv,
                        file_name=f"attendance_stats_{selected_course}_{datetime.now().strftime('%Y%m%d')}.csv",
                        mime="text/csv"
                    )
            else:
...
def mark_attendance_page():
    """Enhanced mobile-friendly attendance marking page with early duplicate check and course filtering"""
